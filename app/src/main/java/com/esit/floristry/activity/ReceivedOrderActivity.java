...
public class ReceivedOrderActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reeived_order);
        ...
        TabLayout tabLayout = (TabLayout) findViewById(R.id.tab_layout_received_order);
        ...
        final ViewPager viewPager = (ViewPager) findViewById(R.id.pager_received_order);
        final OrderPagerAdapter adapter = new OrderPagerAdapter
                (getSupportFragmentManager(), tabLayout.getTabCount(), AppConstants.PAGER_RECEIVED_ORDER_SELLER);
