...
public class ReleasedOrderActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_released_order);
        ...
        tvHomeToolbarTitle.setText("RELEASED ORDER");
        ...
        TabLayout tabLayout = (TabLayout) findViewById(R.id.tab_layout_released_order);
        ...
        final ViewPager viewPager = (ViewPager) findViewById(R.id.pager_released_order);
        final OrderPagerAdapter adapter = new OrderPagerAdapter
                (getSupportFragmentManager(), tabLayout.getTabCount(), AppConstants.PAGER_RELEASED_ORDER);
