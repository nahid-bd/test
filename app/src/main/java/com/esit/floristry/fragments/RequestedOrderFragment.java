...
public class RequestedOrderFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = view.findViewById(R.id.requested_order_recyclerView);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));


        // set order list data
        orderItemList=setOrderItemList();
        orderListRecycleViewAdapter=new OrderListRecycleViewAdapter(orderItemList,"retailer_requested",getContext());
        ...
        recyclerView.addOnItemTouchListener(new RecyclerClickListener(getActivity(), new RecyclerClickListener.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                intent.putExtra("fragment_type","requested");
