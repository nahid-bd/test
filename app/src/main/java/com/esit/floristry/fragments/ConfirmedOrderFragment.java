...
public class ConfirmedOrderFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = view.findViewById(R.id.confirmed_order_recyclerView);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));


        // set order list data
        orderItemList = setOrderItemList();
        orderListRecycleViewAdapter = new OrderListRecycleViewAdapter(orderItemList, "confirmed_order",getContext());
        ...
        recyclerView.addOnItemTouchListener(new RecyclerClickListener(getActivity(), new RecyclerClickListener.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                intent.putExtra("fragment_type","confirmed");
        ...
        for (int x = 0; x < 3; x++) {
            ...
            switch (x) {
                case 0:
                    ...
                    orderItem.setStatusInfo("8 Jan 2019");
                    break;
                case 1:
                    orderItem = new OrderItem();
                    ...
                    orderItem.setStatusInfo("01 Feb 2019");
                    break;
                case 2:
                    orderItem = new OrderItem();
                    ...
                    orderItem.setStatusInfo("28 March 2019");
                    break;
//                case 3:
//                    orderItem = new OrderItem();
//                    orderItem.setOwnerName("Nahidul Islam");
