...
public class ClaimedOrderFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_claimed_order, container, false);

        recyclerView = view.findViewById(R.id.claimed_order_recyclerView);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));


        // set order list data
        orderItemList=setOrderItemList();
        orderListRecycleViewAdapter=new OrderListRecycleViewAdapter(orderItemList,"Claimed_order",getContext());
        ...
        recyclerView.addOnItemTouchListener(new RecyclerClickListener(getActivity(), new RecyclerClickListener.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                intent.putExtra("fragment_type","claim");
        ...
        for (int x=0;x<2;x++){
            ...
            switch (x){
                case 0:
                    ...
                    orderItem.setStatusInfo("15 jan 2019");
                    break;
                case 1:
                    orderItem=new OrderItem();
                    ...
                    orderItem.setStatusInfo("30 Feb 2019");
                    break;
//                case 2:
//                    orderItem=new OrderItem();
