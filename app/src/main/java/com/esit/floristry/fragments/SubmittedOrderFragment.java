...
public class SubmittedOrderFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_submitted_order, container, false);
        recyclerView = view.findViewById(R.id.submitted_order_recyclerView);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));


        // set order list data
        orderItemList = setOrderItemList();
        orderListRecycleViewAdapter = new OrderListRecycleViewAdapter(orderItemList, "submitted_order",getContext());
        ...
        for (int x=0;x<4;x++){
            ...
            switch (x){
                ...
                case 1:
                    ...
                    orderItem.setStatusInfo("19 Feb 2019");
                    break;
                case 2:
                    ...
                    orderItem.setStatusInfo("15 May 2019");
                    break;
                case 3:
                    orderItem=new OrderItem();
                    ...
                    orderItem.setStatusInfo("14 Dec 2019");
                    break;
//                case 4:
//
//
