...
public class ReceivedOrderFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = view.findViewById(R.id.received_order_recyclerView);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));


        // set order list data
        orderItemList=setOrderItemList();
        orderListRecycleViewAdapter=new OrderListRecycleViewAdapter(orderItemList,"received_order",getContext());
        ...
        recyclerView.addOnItemTouchListener(new RecyclerClickListener(getActivity(), new RecyclerClickListener.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                intent.putExtra("fragment_type","received");
        ...
        for (int x=0;x<3;x++){
            ...
            switch (x){
                ...
                case 0:
                    ...
                    orderItem.setStatusInfo("10 Feb 2019");
                    break;
                case 1:
                    orderItem=new OrderItem();
                    ...
                    orderItem.setStatusInfo("30 June 2019");
                    break;
                case 2:
                    orderItem=new OrderItem();
                    ...
                    orderItem.setStatusInfo("14 May 2019");
                    break;
