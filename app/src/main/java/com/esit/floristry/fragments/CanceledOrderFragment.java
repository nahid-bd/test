...
public class CanceledOrderFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = view.findViewById(R.id.canceled_order_recyclerView);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));


        // set order list data
        orderItemList = setOrderItemList();
        orderListRecycleViewAdapter = new OrderListRecycleViewAdapter(orderItemList, "canceled_order", getContext());
...
//                    break;
                ...
                case 1:
                    ...
                    orderItem.setStatusInfo("19 Dec 2019");
                    break;
                case 2:
                    orderItem = new OrderItem();
                    orderItem.setOwnerName("Zahir Uddin Rajon");
                    ...
                    orderItem.setStatusInfo("20 May 2019");
                    break;
                case 3:
                    orderItem = new OrderItem();
                    orderItem.setOwnerName("Shahadath Hossain");
                    ...
                    orderItem.setStatusInfo("15 April 2019");
                    break;
