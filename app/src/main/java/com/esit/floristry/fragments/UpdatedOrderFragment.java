...
public class UpdatedOrderFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_updated_order, container, false);
        recyclerView = view.findViewById(R.id.update_order_recyclerView);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));


        // set order list data
        orderItemList = setOrderItemList();
        orderListRecycleViewAdapter = new OrderListRecycleViewAdapter(orderItemList, "update_order",getContext());
        ...
        recyclerView.addOnItemTouchListener(new RecyclerClickListener(getActivity(), new RecyclerClickListener.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                intent.putExtra("fragment_type","updated");
